...
# Напишите программу,
# которая получает на вход от пользователя два числа: пробег и номер дня
# (первое — обязательно трёхзначное),
...
mile = int(input('Enter your mileage: '))
day = int(input('Enter day of the month: '))
if 99 < mile < 1000:
    sum_num = (mile // 100) + (mile // 10 % 10) + (mile % 10)
    if sum_num > day:
        print('reset')
        mile = 0
    else:
    ...
    print('Such a mileage cannot be')
print('Mileage', mile)