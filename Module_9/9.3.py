...
Некоторым пользователям не нравится пищащий звук. Есть задача убрать звук по готовности
...
"""
reverse_time = int(input('What time do you want to turn on?: '))
for second in range(reverse_time, 0, -1):
    print(second)
    user_answer = int(input('want to pick up? 1-yes 0-no: '))
    if user_answer == 1:
        print('You food is ready', second, 'second')
        break
else:
    print('Your food is ready.hot, attention')
